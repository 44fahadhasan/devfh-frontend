    ...
    <>
      <div className={`${style || ""}`}>
        <button
          ...
          className="text-sm relative inline-flex items-center justify-start px-3 py-2 overflow-hidden font-medium transition-all bg-indigo-500 rounded-full group"
        >
      ...
      <Modal
        ...
        modalHeading={"Your Project, My Expertise!"}
        modalName="HireMe"
        headStyle={"text-xl font-medium"}
      />
    </>
  );
};
