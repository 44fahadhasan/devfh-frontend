...
const ShareCard = () => {
  return (
    <div className="row-auto order-3 md:order-none rounded-lg border-[1px] p-4 border-gray-200 dark:border-neutral-700">
      {/* title */}
      <Heading
        title={"Share Modal"}
      ...
      <div className="my-4">
        {/* sub title */}
        <Paragraph para="Share this link via" style={"text-sm"} />
        ...
        {/* sub title */}
        <Paragraph para="Or copy link" style={"text-sm"} />
        {/* <!--BOX LINK--> */}

        <div className="rounded-full border-[1px] border-gray-200 dark:border-neutral-700 flex justify-between items-center mt-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
          ...
          <input
            className="text-gray-600 dark:text-neutral-400 w-full outline-none bg-transparent text-xs"
            type="text"
            placeholder="link"
            value="https://44fahadhasan.com"
          />
